            ...
            z
                ...
                file: z
                    ...
                    const schemas = [
                        z
                            .string()
                            .describe('The relative path of the file, within the theme folder, to move the key-value pair.'),
                        z.object({
                    ...
                    .describe("The file referenced in this step can be either a string, if the source and target are the same, or an object with 'source' and 'target' properties."),
